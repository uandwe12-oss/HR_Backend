...
async function executeAutoCancelAssetRelease() {
...
function startAutoCancelAssetReleaseScheduler() {
  ...
  cron.schedule('0 0 * * *', async () => {
    ...
    await executeAutoCancelAssetRelease();
  }, {
    timezone: "Asia/Kolkata"
  });
}

module.exports = { startAutoCancelAssetReleaseScheduler, executeAutoCancelAssetRelease };
